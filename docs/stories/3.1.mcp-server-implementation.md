...
- **Framework**: Fiber 2.x for HTTP routing (`services/backend/cmd/api/main.go`)
...
[Source: architecture/coding-standards.md#File Organization, source-tree.md]
Following Single Entity Single File Principle within services structure:
```
services/
