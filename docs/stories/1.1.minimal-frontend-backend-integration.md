...
- [x] Task 4: Docker Configuration (AC: 5, 9)
  ...
  - [x] Create docker-compose.yaml for local development stack
...
**Project Root:**
- Docker composition: `docker-compose.yaml`
- E2E tests: `tests/e2e/`
...
Gate: PASS → docs/qa/gates/1.1-minimal-frontend-backend-integration.yaml
...
Gate: PASS → docs/qa/gates/1.1-minimal-frontend-backend-integration-post-fixes.yaml
