# Test Design: Story 1.2 – Railway Infrastructure Setup
...
| RLY-003 | GitHub Actions | P0 | Workflow `deploy_to_railway.yaml` triggered on `main` | `frontend-dev`/`backend-dev` redeployed, logs show success |
...
- GitHub Actions workflow `.github/workflows/deploy_to_railway.yaml`
