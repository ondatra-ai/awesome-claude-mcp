...
var (
	...
	ErrEmptyAssessmentSummary = errors.New("assessment summary cannot be empty")
	ErrNoStrengthsIdentified  = errors.New("at least one strength must be identified")
	ErrRiskLevelRequired      = errors.New("risk level must be specified")
	ErrTestabilityOutOfRange  = errors.New("testability score must be between 1 and 10")
	ErrReadinessOutOfRange    = errors.New("implementation readiness must be between 1 and 10")
	ErrNoTestScenarios        = errors.New("at least one test scenario must be specified")
	ErrAIGeneratedNoTasks     = errors.New("AI generated no tasks")
	ErrEmptyTestLocation      = errors.New("test location cannot be empty")
	ErrNoTestingFrameworks    = errors.New("at least one testing framework must be specified")
	ErrNoTestingRequirements  = errors.New("at least one testing requirement must be specified")
	ErrNoCoverageTargets      = errors.New("coverage targets must be specified")
)
